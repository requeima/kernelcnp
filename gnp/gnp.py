...
class GNP(nn.Module):
    ...
    def __init__(self,
        ...
        self.output_dim = output_dim
        self.latent_dim = latent_dim
        self.num_channels = output_dim + cov.num_basis_dim + cov.extra_cov_dim + noise.extra_noise_dim
        self.use_attention = use_attention
        self.cov = cov
        self.noise = noise
        ...
        self.decoder = StandardDecoder(input_dim=self.input_dim + self.latent_dim,
                                       latent_dim=self.latent_dim,
...
class TEGNP(GNP):
    ...
    def forward(x_ctx, y_ctx, x_trg):
        ...
        # Latent representation of context set
        r = self.encoder(ctx)
    ...
    def decode(self, x_ctx, x_trg, r, noiseless=False):
        
        #
        
        # Embedding containing mean function and covariance features
        z = self.decoder(x_trg, r)
